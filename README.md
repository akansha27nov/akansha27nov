...
- **[Strict Complaint Processing Agent](https://github.com/akansha27nov/Chaos-agent-tools-lore-less-questionable-judgments)** — rebuilds the complaint agent as a graph with defined stages — intake, investigation, resolution — enforcing stricter checks at each step before a final answer is returned.
- **[Complaint Handling Agent (LangChain)](https://github.com/akansha27nov/Chaos-agent)** — takes in a customer complaint, classifies the issue, drafts a resolution, and checks its own answer against the source evidence before responding.
- **[Document Q&A Agent (MCP)](https://github.com/akansha27nov/Agents-that-speak-MCP-fluently)** — answers questions about a set of documents by calling a custom MCP server for the relevant content, instead of reading files directly.
